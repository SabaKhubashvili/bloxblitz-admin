...
import type {
  ITowersOverviewRepository,
  TowersOverviewChartBucketRow,
  TowersOverviewStatsRow,
} from '../domain/towers-overview.repository';
...
@Injectable()
export class PrismaTowersOverviewRepository implements ITowersOverviewRepository {

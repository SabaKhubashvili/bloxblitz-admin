  ...
  return (
    <div
      className={cn(
        ...
        "hover:-translate-y-0.5 hover:border-violet-500/25 hover:shadow-lg hover:shadow-violet-500/10"
      )}
    >
      <div className="flex items-start justify-between gap-2">
        ...
        {icon ? (
          <span className="text-zinc-600 transition-colors group-hover:text-violet-400/90">
            {icon}
          </span>
        ) : null}
      </div>

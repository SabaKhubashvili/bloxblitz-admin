...
interface ConfirmDialogProps {
  ...
  /** When true, confirm/cancel buttons are disabled (e.g. async confirm in flight). */
  busy?: boolean;
}
...
const btn = {
  ...
  primary:
    "bg-gradient-to-r from-sky-600 to-blue-600 text-white shadow-lg hover:from-sky-500 hover:to-blue-500",
};
      ...
      <div className="p-6">
        ...
        <div className="mt-6 flex flex-wrap justify-end gap-3">
          <button
            ...
            disabled={busy}
            onClick={onClose}
            className="rounded-xl px-4 py-2.5 text-sm font-medium text-zinc-400 hover:bg-zinc-800 hover:text-zinc-200 disabled:opacity-40"
          >
            {cancelLabel}
          </button>
          <button
